  ...
  const plans: TPlan[] = [
    {
      ...
      price: 0,
      features: [
        "Everything from Basic Plan for 14 days",
        "1 form",
        "100 submissions",
        "Email support",
      ],
      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 mt-10 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {plans.map((plan, index) => (
            <div
              key={index}
              className={`flex flex-col justify-between items-center p-8 transition-shadow bg-background border rounded-xl shadow-md hover:shadow-xl ${
                plan.highlighted
              ...
              <ul className="mt-3 space-y-3 text-left w-full flex flex-col items-start justify-start">
