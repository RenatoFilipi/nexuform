...
import { ArrowUpRightIcon, ChevronLeftIcon, HexagonIcon, LoaderIcon, PlusIcon, RocketIcon } from "lucide-react";
    ...
    <div className="flex flex-col gap-6 sm:gap-10">
      <div className="flex justify-start items-center gap-2">
        <Link href={returnPath} className="flex justify-center items-center">
          <ChevronLeftIcon className="hover:text-muted-foreground w-7 h-7" />
        </Link>
