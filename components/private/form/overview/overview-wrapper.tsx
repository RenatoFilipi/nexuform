...
const OverviewCard = ({
  ...
  return (
    <Card className="relative group p-4 flex flex-col justify-between w-full h-full border hover:border-primary bg-card shadow-xs rounded-lg transition-all duration-300 hover:shadow-xs overflow-hidden">
