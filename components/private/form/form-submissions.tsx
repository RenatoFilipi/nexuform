        ...
        <div className="w-full h-full flex-1 py-24">
          <div className="flex flex-col justify-center items-center gap-3">
            ...
            <div className="flex flex-col justify-center items-center">
              <span className="text-foreground font-semibold">No submission to show</span>
              <p className="text-sm text-muted-foreground">Your form hasn’t received any submissions yet.</p>
            </div>
          </div>
        </div>
      )}
      {submissions.length > 0 && isDesktop && (
