  ...
  return [
    {
      ...
      features: [
        ...
        { description: t("app.feat_basic_templates"), comingSoon: false },
        { description: t("app.feat_basic_integrations"), comingSoon: true },
        { description: t("app.feat_email_notifications"), comingSoon: true },
      ],
    ...
    },
    {
      ...
      features: [
        ...
        { description: t("app.feat_premium_templates"), comingSoon: false },
        { description: t("app.feat_premium_analytics"), comingSoon: true },
        { description: t("app.feat_email_notifications"), comingSoon: true },
        { description: t("app.feat_premium_integrations"), comingSoon: true },
        { description: t("app.label_soon"), comingSoon: false },
      ],
      ctaButton: t("app.label_upgrade_now"),
    },
  ];
