...
export type EBlock = Tables<"blocks">;
export type EFeedback = Tables<"feedbacks">;
export type EForm = Tables<"forms">;
export type EFormAnalytics = Tables<"forms_analytics">;
export type EIntegration = Tables<"integrations">;
export type EInvoice = Tables<"invoices">;
export type ENotification = Tables<"notifications">;
export type EOrganization = Tables<"organizations">;
export type EProfile = Tables<"profiles">;
...
export type EUsage = Tables<"usages">;
